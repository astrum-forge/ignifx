...
| Item                | Value                                                                                                                                                                                                                           |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Engine version      | unreleased (`0.0.0`); `@ignifx/core`, `@ignifx/input`, `@ignifx/audio`, `@ignifx/physics`, `@ignifx/2d`, `@ignifx/physics-2d`, `@ignifx/3d`, `@ignifx/ui`, `@ignifx/electron`, `@ignifx/vite-plugin`, and the `ignifx` umbrella |
...
| Every exact signature                 | [`api/core.md`](references/api/core.md) · [`api/input.md`](references/api/input.md) · [`api/audio.md`](references/api/audio.md) · [`api/physics.md`](references/api/physics.md) · [`api/physics-2d.md`](references/api/physics-2d.md) · [`api/2d.md`](references/api/2d.md) · [`api/ui.md`](references/api/ui.md) · [`api/3d.md`](references/api/3d.md) · [`api/electron.md`](references/api/electron.md) · the subsystem skills under `packages/*/skills/` |
