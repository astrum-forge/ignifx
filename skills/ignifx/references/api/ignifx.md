...
[`IgnifxError`](#ignifxerror).[`constructor`](#constructor-14)
...
[`IgnifxError`](#ignifxerror).[`name`](#name-10)
...
[`Component`](#abstract-component).[`constructor`](#constructor-6)
...
[`Component`](#abstract-component).[`enabled`](#enabled-4)
...
[`InputDevice`](#inputdevice).[`constructor`](#constructor-18)
...
[`InputDevice`](#inputdevice).[`kind`](#kind-13)
...
Whether [InputActionSet.dispose](#dispose-3) has run.
...
`true` once [MeshAsset.dispose](#dispose-5) has run.
...
`true` once [World.dispose](#dispose-9) has run.
...
> **inputSettingsSchema**(): [`Schema`](#schema-11)
