...
export const FEATURE_SECTIONS: readonly FeatureSection[] = [
  ...
  },
  {
    ...
    body: "Write WGSL in a .wgsl file whose comment pragmas declare its uniforms and textures. Use it as a full material, as hooks on the PBR material, or as a full-screen pass.",
    bullets: [
    ...
    chips: [
      { label: "Custom shader", target: "custom-shader", fallback: "Shaders" },
      { label: "Surface shaders", target: "surface-shaders", fallback: "Shaders" },
      { label: "Vertex animation", target: "vertex-animation", fallback: "Shaders" },
      { label: "Custom post-process", target: "custom-post-process", fallback: "Shaders" },
      { label: "Instancing", target: "instancing", fallback: "Rendering" },
    ],
  },
  {
    id: "particles",
    title: "Particles",
    packages: "@ignifx/particles and @ignifx/particles-2d",
    body: "Play fire, smoke, sparks and weather from a .particles.json definition. The GPU evaluates every particle from its spawn record, so the CPU only writes what changed.",
    bullets: [
    ...
    chips: [
      { label: "Presets", target: "particles", fallback: "Particles" },
      { label: "Explosion", target: "explosion", fallback: "Particles" },
      { label: "Weather", target: "weather", fallback: "Particles" },
      { label: "2D particles", target: "particles-2d", fallback: "Particles" },
    ],
  },
  {
    id: "terrain",
    title: "Terrain",
    packages: "@ignifx/terrain",
    body: "Load a 16-bit heightmap or generate one from seeded noise. Chunked level of detail, a layered splat material and height queries come with it.",
    bullets: [
    ...
    chips: [
      { label: "Heightmap terrain", target: "terrain", fallback: "Terrain" },
      { label: "Procedural terrain", target: "terrain-procedural", fallback: "Terrain" },
      { label: "Foliage", target: "terrain-foliage", fallback: "Terrain" },
      { label: "Walk on terrain", target: "terrain-walk", fallback: "Terrain" },
    ],
  },
  {
    id: "assets",
