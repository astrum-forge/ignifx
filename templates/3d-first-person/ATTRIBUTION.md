...
| File                                                                                                | What it is                                                                                                                                                       |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `viewmodel.glb`                                                                                     | A generated four-joint "box-man" rig with `idle`/`walk`/`run`/`jump` clips and a `hand` node.                                                                    |
...
The view model is the same generated rig, welded to the character's `hand` node by
`src/scripts/attach-to-hand.ts`.
